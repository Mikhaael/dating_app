...
class TypeField extends StatelessWidget {
  ...
  const TypeField({Key? key, required this.state}) : super(key: key);
...
class InputTextFieldWidget extends StatelessWidget {
  ...
  const InputTextFieldWidget({Key? key, required this.textEditingController, required this.hintText, required this.state}) : super(key: key);
